...
const Footer = () => {
    ...
    return (
        <div className="pt-0 px-0 lg:px-20 lg:pb-4 select-none">
        <div className="footer items-center p-4 bg-base-200 lg:rounded-box lg:shadow-lg lg:divide-y border-t lg:border-t-0 border-base-300">
            <div className="items-center grid-flow-col">
                ...
                <p>Copyright © 2024 - Second Language </p>
            </div>
